      ...
      <div className="flex flex-col items-center justify-center min-h-[80vh] text-center px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Upload documents, store knowledge securely, and ask natural language questions. 
            Powered by cutting-edge AI to transform how you interact with your information.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16 max-w-5xl mx-auto">
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
            ...
            <p className="text-gray-300">Drag & drop documents, automatically extract and process content</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
            ...
            <p className="text-gray-300">Ask questions in natural language and get intelligent answers</p>
          </div>
